...
-- New May Need Translations
	...
	--9.3.11.24 a Additions
	PCHAT_CHAT_TAB_CHANNELS = "Chat Tab Channels",
	PCHAT_SETTINGS_CHAT_TAB_DESC = "General chat tab settings, further down the settings menu there is settings to set chat channels for each tab.",
	PCHAT_SETTINGS_MESSAGE_SETTINGS_DESC = "General settings of how messages appear, color options, lines displayed, clickable links, and more",
	PCHAT_SETTINGS_PARTY_CHANNEL_TWEAKS = "Tweaks to group/party chat. including default group channel setup.",
	PCHAT_SETTINGS_SYNC_DESC = "Setting up chat sync operations, that will sync the settings of the chat window between characters.",
	PCHAT_SETTINGS_APPARENCEMH_DESC = "Chat Window appearance settings",
	PCHAT_SETTINGS_IM_DESC = "Whisper/Tell tweaks and settings.",
	PCHAT_SETTINGS_RESTORECHAT_DESC = "Settings for how to handle Chat Restore.  History of chat is saved for a pre determined amount of time.",
	PCHAT_enableChatTabDefault = "Default channels for chat tabs",
	PCHAT_enableChatTabDefault_TT = "Set default channels for specific chat tab, can be set to none. You can leave Enable Last Used Channel Per Tab on for any tabs that you do not select a channel, otherwise the default will override it.",
	
	
	
	
	PCHAT_CHAT_CHANNEL_SAY = "Say",
	PCHAT_CHAT_CHANNEL_YELL = "Yell",
	PCHAT_CHAT_CHANNEL_WHISPER = "Whisper Incoming/Outgoing",
	PCHAT_CHAT_CHANNEL_ZONE = "Zone",
	PCHAT_CHAT_CHANNEL_PARTY = "Party/Group",
	PCHAT_CHAT_CHANNEL_EMOTE = "Emote",
	PCHAT_CHAT_CHANNEL_SYSTEM = "System",
	PCHAT_GUILD = "Guild",
	PCHAT_OFFICER = "Officer",
	PCHAT_CHAT_CHANNEL_GUILD_1 = "Guild 1",
	PCHAT_CHAT_CHANNEL_GUILD_OFFICER_1 = "Guild 1 Officer",
	PCHAT_CHAT_CHANNEL_GUILD_2 = "Guild 2",
	PCHAT_CHAT_CHANNEL_GUILD_OFFICER_2 = "Guild 2 Officer",
	PCHAT_CHAT_CHANNEL_GUILD_3 = "Guild 3",
	PCHAT_CHAT_CHANNEL_GUILD_OFFICER_3 = "Guild 3 Officer",
	PCHAT_CHAT_CHANNEL_GUILD_4 = "Guild 4",
	PCHAT_CHAT_CHANNEL_GUILD_OFFICER_4 = "Guild 4 Officer",
	PCHAT_CHAT_CHANNEL_GUILD_5 = "Guild 5",
	PCHAT_CHAT_CHANNEL_GUILD_OFFICER_5 = "Guild 5 Officer",
	PCHAT_CHAT_CHANNEL_MONSTER = "NPC (Monster Say/Yell/Whisper/Emote)",
	PCHAT_CHAT_CHANNEL_ZONE = "Zone",
	PCHAT_CHAT_CHANNEL_ZONE_EN = "Zone - English",
	PCHAT_CHAT_CHANNEL_ZONE_GR = "Zone - German",
	PCHAT_CHAT_CHANNEL_ZONE_FR = "Zone - French",
	PCHAT_CHAT_CHANNEL_ZONE_JP = "Zone - Japanese",
	
	PCHAT_PARTYTAB = "Group Tab",
	PCHAT_PARTYTABTT = "Tab for group chat, pChat will switch to this tab when in group.",

	--9.3.11.24 b Additions
	PCHAT_CHAT_TAB_DEFAULT_CHANNEL = "Default Channel for Tab",
	PCHAT_CHAT_TAB_DEFAULT_CHANNEL_TT = "Set the default channel for the tab, if none is selected and setting to remember last channel is used, it will default to last used.  If Default is selected it will override last channel.",

	PCHAT_CHAT_LOCK_DEFAULT = "Lock default channel to Tab",
	PCHAT_CHAT_LOCK_DEFAULT_TT = "Lock the tab to the default channel selected, you can still send messages to other channels however it will default back to the selected channel.",
-- New Need Translations
	...
	PCHAT_DEFAULTCHANNELCHOICE99 = "Do not change",
	PCHAT_DEFAULTCHANNELCHOICE31 = "Zone",
	PCHAT_DEFAULTCHANNELCHOICE3 = "Party",
	PCHAT_DEFAULTCHANNELCHOICE0 = "Say",
	PCHAT_DEFAULTCHANNELCHOICE1 = "Yell",
	PCHAT_DEFAULTCHANNELCHOICE6 = "Emote",
	PCHAT_DEFAULTCHANNELCHOICE12 = "Guild 1",
	PCHAT_DEFAULTCHANNELCHOICE13 = "Guild 2",
	PCHAT_DEFAULTCHANNELCHOICE14 = "Guild 3",
	PCHAT_DEFAULTCHANNELCHOICE15 = "Guild 4",
	PCHAT_DEFAULTCHANNELCHOICE16 = "Guild 5",
	PCHAT_DEFAULTCHANNELCHOICE17 = "Officer 1",
	PCHAT_DEFAULTCHANNELCHOICE18 = "Officer 2",
	PCHAT_DEFAULTCHANNELCHOICE19 = "Officer 3",
	PCHAT_DEFAULTCHANNELCHOICE20 = "Officer 4",
	PCHAT_DEFAULTCHANNELCHOICE21 = "Officer 5",
	PCHAT_DEFAULTCHANNELCHOICE32 = "Zone English",
	PCHAT_DEFAULTCHANNELCHOICE33 = "Zone French",
	PCHAT_DEFAULTCHANNELCHOICE34 = "Zone German",
	PCHAT_DEFAULTCHANNELCHOICE35 = "Zone Japanese",
